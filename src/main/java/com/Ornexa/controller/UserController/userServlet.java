...
public class userServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// fetch wishlist
		List<WishlistItem> wishlist = wishlistService.getWishlistItems(userId);
		System.out.println("PROFILE WISHLIST SIZE = " + wishlist.size());
		...
		request.getRequestDispatcher("/WEB-INF/pages/Users/user.jsp")
