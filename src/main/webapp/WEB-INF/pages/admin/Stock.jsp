...
<div class="layout-wrapper">
    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            <img src="<%= request.getContextPath() %>/picture/OrnexaAdmin.png" alt="ORNEXA" class="sidebar-logo">
        ...
        <div class="dashboard-grid">
            ...
            <section class="ledger-card">
                ...
                <div class="product-row">
                    <div class="cell-main">
                        <img src="<%= request.getContextPath() %>/picture/Rectangle 315.png" class="item-img">
                        <div>
                ...
                <div class="product-row">
                    <div class="cell-main">
                        <img src="<%= request.getContextPath() %>/picture/braclet-men.png" class="item-img">
                        <div>
            ...
            <aside class="side-widgets">
                ...
                <div class="widget warning-widget">
                    ...
                    <p>12 items have fallen below the critical threshold.</p>
