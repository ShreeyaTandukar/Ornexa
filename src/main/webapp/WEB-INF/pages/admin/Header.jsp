...
<header class="header_section">
  ...
  <div class="container">
    ...
    <nav class="navbar">
      ...
      <img src="${pageContext.request.contextPath}/picture/ornexa.png"
           class="logo">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link"
             href="${pageContext.request.contextPath}/Home_pageServlet">
             Home
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link"
             href="${pageContext.request.contextPath}/AboutUsServlet">
             About Us
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link"
             href="${pageContext.request.contextPath}/ContactUsServlet">
             Contact Us
          </a>
        </li>
