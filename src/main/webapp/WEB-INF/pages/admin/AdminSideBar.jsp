...
<aside class="sidebar">
    ...
    <div class="sidebar-header">
        ...
        <img src="${pageContext.request.contextPath}/picture/OrnexaAdmin.png"
             alt="ORNEXA"
             class="sidebar-logo">
    ...
    <nav class="nav-menu">
        ...
        <a href="${pageContext.request.contextPath}/StockManagement"
...
<div id="addModal" class="modal ${not empty openAddModal ? 'show' : ''}">
    <div class="modal-content">
        ...
        <form action="${pageContext.request.contextPath}/Product" method="post">
            ...
            <input type="number" name="price" placeholder="Price" value="${param.price}">

            <input type="number" name="stockQuantity" placeholder="Stock" value="${param.stockQuantity}">

            <select name="material">
                <option value="">Select Material</option>
                <option value="Gold" ${param.material == 'Gold' ? 'selected' : ''}>Gold</option>
                <option value="Silver" ${param.material == 'Silver' ? 'selected' : ''}>Silver</option>
                <option value="Diamond" ${param.material == 'Diamond' ? 'selected' : ''}>Diamond</option>
            </select>
            ...
            <select name="style">
                ...
                <option value="Traditional" ${param.style == 'Traditional' ? 'selected' : ''}>Traditional</option>
                <option value="Modern" ${param.style == 'Modern' ? 'selected' : ''}>Modern</option>
            </select>
            ...
            <select name="categoryId">
                ...
                <option value="1" ${param.categoryId == '1' ? 'selected' : ''}>Necklace</option>
                <option value="2" ${param.categoryId == '2' ? 'selected' : ''}>Earring</option>
                <option value="3" ${param.categoryId == '3' ? 'selected' : ''}>Ring</option>
                <option value="4" ${param.categoryId == '4' ? 'selected' : ''}>Bracelet</option>
            </select>
