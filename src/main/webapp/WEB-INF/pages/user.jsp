	...
	<div class="main-layout">
		<div class="left-column">
			...
			<div class="stats-row">
				...
				<a href="${pageContext.request.contextPath}/WishListServlet" class="stat-card-link">
					<div class="stat-card">
			...
			<section class="wishlist-section">
				<div class="section-header">
					<h2>My Wishlist</h2>
					<a href="${pageContext.request.contextPath}/WishListServlet" class="view-all">View All</a>
				</div>
