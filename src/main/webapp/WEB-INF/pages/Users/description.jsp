...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/description.css">
...
<div class="product-container">
	...
	<div class="left-col">
		<div class="img-placeholder">
			<img src="${pageContext.request.contextPath}/picture/${product.imgUrl}" alt="${product.name}">
		</div>
	</div>
